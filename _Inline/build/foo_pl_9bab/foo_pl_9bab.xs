...
MODULE = foo_pl_9bab PACKAGE = foo_pl_9bab
...
set_boundscheck(i)
       ...
       CODE:
       if (! 1)
         warn("Bounds checking is disabled for foo_pl_9bab");
...
MODULE = foo_pl_9bab PACKAGE = PDL
...
#define aTHX_
   ...
   if (PDL->Version != PDL_CORE_VERSION)
     Perl_croak(aTHX_ "foo_pl_9bab needs to be recompiled against the newly installed PDL");
