...
MODULE = foo_pl_31a5 PACKAGE = foo_pl_31a5
...
set_boundscheck(i)
       ...
       CODE:
       if (! 1)
         warn("Bounds checking is disabled for foo_pl_31a5");
...
MODULE = foo_pl_31a5 PACKAGE = PDL
...
#define aTHX_
   ...
   if (PDL->Version != PDL_CORE_VERSION)
     Perl_croak(aTHX_ "foo_pl_31a5 needs to be recompiled against the newly installed PDL");
