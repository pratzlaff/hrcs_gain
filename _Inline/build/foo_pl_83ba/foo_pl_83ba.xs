...
MODULE = foo_pl_83ba PACKAGE = foo_pl_83ba
...
set_boundscheck(i)
       ...
       CODE:
       if (! 1)
         warn("Bounds checking is disabled for foo_pl_83ba");
...
MODULE = foo_pl_83ba PACKAGE = PDL
...
#define aTHX_
   ...
   if (PDL->Version != PDL_CORE_VERSION)
     Perl_croak(aTHX_ "foo_pl_83ba needs to be recompiled against the newly installed PDL");
