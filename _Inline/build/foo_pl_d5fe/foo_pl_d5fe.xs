...
MODULE = foo_pl_d5fe PACKAGE = foo_pl_d5fe
...
set_boundscheck(i)
       ...
       CODE:
       if (! 1)
         warn("Bounds checking is disabled for foo_pl_d5fe");
...
MODULE = foo_pl_d5fe PACKAGE = PDL
...
#define aTHX_
   ...
   if (PDL->Version != PDL_CORE_VERSION)
     Perl_croak(aTHX_ "foo_pl_d5fe needs to be recompiled against the newly installed PDL");
