...
MODULE = foo_pl_721b PACKAGE = foo_pl_721b
...
set_boundscheck(i)
       ...
       CODE:
       if (! 1)
         warn("Bounds checking is disabled for foo_pl_721b");
...
MODULE = foo_pl_721b PACKAGE = PDL
...
#define aTHX_
   ...
   if (PDL->Version != PDL_CORE_VERSION)
     Perl_croak(aTHX_ "foo_pl_721b needs to be recompiled against the newly installed PDL");
